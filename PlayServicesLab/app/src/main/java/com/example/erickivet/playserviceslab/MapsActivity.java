...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, FusedLocationProviderApi,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(ContextCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if(mLocation != null){
                ...
                LatLng markerDrop = new LatLng(mLatitude, mLongitude);
                mMap.addMarker(new MarkerOptions().position(markerDrop).title("Your Location"));
            }
        }
